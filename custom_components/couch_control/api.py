...
class PairingCreateView(HomeAssistantView):
    url = "/api/couch_control/pairing/create"
    name = "api:couch_control:pairing:create"
    requires_auth = False
    ...
    async def post(self, request: web.Request) -> web.Response:
        ...
        persistent_notification.async_create(
            ...
            f"`couch_control.approve_pairing`.",
...
class PairingStatusView(HomeAssistantView):
    url = "/api/couch_control/pairing/status"
    name = "api:couch_control:pairing:status"
    requires_auth = False
...
class PairingApproveView(HomeAssistantView):
    url = "/api/couch_control/pairing/approve"
    name = "api:couch_control:pairing:approve"
    requires_auth = True
...
class PairingExchangeView(HomeAssistantView):
    url = "/api/couch_control/pairing/exchange"
    name = "api:couch_control:pairing:exchange"
    requires_auth = False
...
async def async_setup_api(hass: HomeAssistant) -> None:
    for view in (
        CouchControlEntitiesView(),
        CouchControlInfoView(),
        PairingCreateView(),
        PairingStatusView(),
        PairingApproveView(),
        PairingExchangeView(),
